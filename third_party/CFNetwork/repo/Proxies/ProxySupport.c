...
#else
CONST_STRING_DECL_LOCAL(_kProxySupportCFNetworkBundleID, "com.apple.CFNetwork")
CONST_STRING_DECL_LOCAL(_kProxySupportLocalhost, "localhost")
CONST_STRING_DECL_LOCAL(_kProxySupportIPv4Loopback, "127.0.0.1")
CONST_STRING_DECL_LOCAL(_kProxySupportIPv6Loopback, "::1")
CONST_STRING_DECL_LOCAL(_kProxySupportDot, ".")
CONST_STRING_DECL_LOCAL(_kProxySupportSlash, "/")
CONST_STRING_DECL_LOCAL(_kProxySupportDotZero, ".0")
CONST_STRING_DECL_LOCAL(_kProxySupportDotFormat, ".%@")
CONST_STRING_DECL_LOCAL(_kProxySupportStar, "*")
CONST_STRING_DECL_LOCAL(_kProxySupportColon, ":")
CONST_STRING_DECL_LOCAL(_kProxySupportSemiColon, ";")
CONST_STRING_DECL_LOCAL(_kProxySupportFILEScheme, "file")
CONST_STRING_DECL_LOCAL(_kProxySupportHTTPScheme, "http")
CONST_STRING_DECL_LOCAL(_kProxySupportHTTPSScheme, "https")
CONST_STRING_DECL_LOCAL(_kProxySupportHTTPPort, "80")
CONST_STRING_DECL_LOCAL(_kProxySupportFTPScheme, "ftp")
CONST_STRING_DECL_LOCAL(_kProxySupportFTPSScheme, "ftps")
CONST_STRING_DECL_LOCAL(_kProxySupportFTPPort, "21")
CONST_STRING_DECL_LOCAL(_kProxySupportSOCKS4Scheme, "socks4")
CONST_STRING_DECL_LOCAL(_kProxySupportSOCKS5Scheme, "socks5")
CONST_STRING_DECL_LOCAL(_kProxySupportSOCKSPort, "1080")
CONST_STRING_DECL_LOCAL(_kProxySupportDIRECT, "DIRECT")
CONST_STRING_DECL_LOCAL(_kProxySupportPROXY, "PROXY")
CONST_STRING_DECL_LOCAL(_kProxySupportSOCKS, "SOCKS")
CONST_STRING_DECL_LOCAL(_kProxySupportGETMethod, "GET")
CONST_STRING_DECL_LOCAL(_kProxySupportURLLongFormat, "%@://%@:%@@%@:%d")
CONST_STRING_DECL_LOCAL(_kProxySupportURLShortFormat, "%@://%@:%d")
CONST_STRING_DECL_LOCAL(_kProxySupportExceptionsList, "ExceptionsList")
CONST_STRING_DECL_LOCAL(_kProxySupportLoadingPacPrivateMode, "_kProxySupportLoadingPacPrivateMode")
CONST_STRING_DECL_LOCAL(_kProxySupportPacSupportFileName, "PACSupport")
CONST_STRING_DECL_LOCAL(_kProxySupportJSExtension, "js")
CONST_STRING_DECL_LOCAL(_kProxySupportExpiresHeader, "Expires")
CONST_STRING_DECL_LOCAL(_kProxySupportNowHeader, "Date")

...
#else
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamFTPScheme, "ftp")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamFTPSScheme, "ftps")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamHTTPScheme, "http")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamHTTPSScheme, "https")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamSOCKS4Scheme, "socks4")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamSOCKS5Scheme, "socks5")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamUserAgentHeader, "User-Agent")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamProxyAuthorizationHeader, "Proxy-Authorization")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamDescribeFormat, "<HTTP request stream %p>{url = %@, state = %d, flags=%d}")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamContentLengthHeader, "Content-Length")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamContentLengthFormat, "%d")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamConnectionHeader, "Connection")
...
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamConnectionClose, "close")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamConnectionSeparator, ",")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamHostHeader, "Host")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamHostFormat, "%@:%d")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamLocationHeader, "Location")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamLocationSeparator, ", ")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamHEADMethod, "HEAD")
CONST_STRING_DECL_LOCAL(_kCFStreamSocketCreatedCallBack, "_kCFStreamSocketCreatedCallBack")
CONST_STRING_DECL_LOCAL(_kCFHTTPStreamPrivateRunLoopMode, "_kCFHTTPStreamPrivateRunLoopMode")

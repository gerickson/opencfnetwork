...
#else
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageAcceptRangesHeader, "Accept-Ranges")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageCacheControlHeader, "Cache-Control")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageConnectHeader, "Connection")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageContentLanguageHeader, "Content-Language")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageContentLengthHeader, "Content-Length")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageContentLocationHeader, "Content-Location")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageContentTypeHeader, "Content-Type")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageDateHeader, "Date")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageEtagHeader, "Etag")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageExpiresHeader, "Expires")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageLastModifiedHeader, "Last-Modified")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageLocationHeader, "Location")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageProxyAuthenticateHeader, "Proxy-Authenticate")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageServerHeader, "Server")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageSetCookieHeader, "Set-Cookie")
...
#else
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageDescribeFormat, "<CFHTTPMessage 0x%x>{url = %@; %@ = %@}")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageDescribeRequest, "request")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageDescribeStatus, "status")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageGETMethod, "GET")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageResponseLineFormat, " %d ")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageSpace, " ")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageEmptyString, "")
CONST_STRING_DECL_LOCAL(_kCFHTTPMessageAppendHeaderFormat, "%@, %@")
#endif	/* __CONSTANT_CFSTRINGS__ */

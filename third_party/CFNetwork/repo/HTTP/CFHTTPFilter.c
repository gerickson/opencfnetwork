...
#else
CONST_STRING_DECL_LOCAL(_kCFHTTPFilterCommaSeparator, ",")
CONST_STRING_DECL_LOCAL(_kCFHTTPFilterContentLengthHeader, "Content-Length")
CONST_STRING_DECL_LOCAL(_kCFHTTPFilterTransferEncodingHeader, "Transfer-Encoding")
CONST_STRING_DECL_LOCAL(_kCFHTTPFilterTransferEncodingChunked, "chunked")
CONST_STRING_DECL_LOCAL(_kCFHTTPFilterTransferEncodingChunked2, "Chunked")
CONST_STRING_DECL_LOCAL(_kCFHTTPFilterTransferEncodingChunkedSeparator, ", Chunked")
CONST_STRING_DECL_LOCAL(_kCFHTTPFilterTransferEncodingIdentity, "Identity")
CONST_STRING_DECL_LOCAL(_kCFHTTPFilterTrailingHeadersFormat, "%@, %@")
CONST_STRING_DECL_LOCAL(_kCFHTTPFilterProxyAuthorizationHeader, "Proxy-Authorization")
CONST_STRING_DECL_LOCAL(_kCFHTTPFilterHTTPSScheme, "https")
